...
class Decks {
    ...
    public Decks(boolean withJokers)
    {
        ...
        // going to add all the cards to both decks
            ...
            for (int suit = 1; suit <= 4; suit++)
                {
                    ...
                    {
                        Card makeCard = new Card(suit, rank);
                        originalDecks.add(makeCard);
                        gameDecks.add(makeCard);
        ...
        catch(PlayingCardException b){
            b.printStackTrace();
            System.out.println("PlayingCardException: " + b.getMessage());
        }
    }
    ...
    public Decks(int n, boolean withJokers)
    {
        ...
        try{
            ...
            for (int numberOfDecks = 0; numberOfDecks < n; numberOfDecks++)
                {
                    for (int suit = 1; suit <= 4; suit++)
                    {
                        for(int rank = 1; rank <= 13; rank++)
    ...
    public List<Card> deal(int numberCards) throws PlayingCardException
    {
        ...
        try
        {
            ...
            for (int a = numberCards-1; a >= 0; a--)
            {
                Card randomCard = gameDecks.remove(a);
