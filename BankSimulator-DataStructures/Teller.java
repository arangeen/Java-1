...
class Teller {
   ...
   {
	//add statements
       totalFreeTime += startFreeTime+endFreeTime;
   }

   void updateTotalBusyTime()
   {
	//add statements
       totalBusyTime += startBusyTime + endBusyTime;
   }
   ...
   void freeToBusy (Customer newCustomer, int currentTime)
   {
	...
	//add statements
       ...
       totalFreeTime += (currentTime - startBusyTime);
       startBusyTime = currentTime;
       endBusyTime = startBusyTime + newCustomer.getTransactionTime();
