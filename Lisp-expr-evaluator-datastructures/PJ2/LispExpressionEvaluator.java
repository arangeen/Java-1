...
public class LispExpressionEvaluator
{
	...
	if (inputExprStack.isEmpty())
        ...
        double answer;
        Object pop = inputExprStack.pop();
        if (!pop.equals(pop.toString()))
        {
            throw new LispExpressionEvaluatorException("LispExpressionException ");
        }
        ...
        try
        {
            while (pop.equals(pop.toString()))
            {
                evaluationStack.push(Double.parseDouble(pop.toString()));
                pop = inputExprStack.pop();
            }
        
        }
        catch (EmptyStackException p)
        {
             throw new LispExpressionEvaluatorException("LispExpressionEvaluatorException");
        }
        
        String q = pop.toString();
                        ...
                        if (evaluationStack.isEmpty())
                            {
                                ...
                                inputExprStack.push(Double.toString(answer));
                                break;
